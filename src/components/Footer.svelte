...
>
  ...
  <div class="flex flex-col gap-4 items-center justify-center">
    ...
    <a href="mailto:aquon_bovell@outlook.com"
      ><b class="pr-2">Email</b>aquon_bovell@outlook.com</a
    >
    <p>
      <b class="pr-2">GitHub</b>
      <a
        href="https://github.com/aquonbovell"
        target="_blank"
        class="text-violet-400"
        >aquon_bovell<sup class=""
    ...
    <p>
      ...
      <a
        href="www.linkedin.com/in/aquon-bovell-184874163"
        target="_blank"
        class="text-violet-400"
        >Aquon Bovell<sup class=""
          ><span class="text-xs scale-75 pl-0.5"
            ><i
              class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"
            /></span
